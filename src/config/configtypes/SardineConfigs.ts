import {
  ...
  SARDINE_AWS_SECRET_KEY_FOR_SARDINE_WEBHOOK_SECRET_KEY_ATTR,
  SARDINE_CLIENT_ID,
  SARDINE_SECRET_KEY,
  SARDINE_URI,
  SARDINE_WEBHOOK_SECRET_KEY,
...
export interface SardineConfigs {
  ...
  [SARDINE_AWS_SECRET_KEY_FOR_SARDINE_WEBHOOK_SECRET_KEY_ATTR]: string;
  [SARDINE_CLIENT_ID]: string;
  [SARDINE_WEBHOOK_SECRET_KEY]: string;
