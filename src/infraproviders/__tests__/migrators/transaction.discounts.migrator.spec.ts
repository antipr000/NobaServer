...
import { TransactionDiscountsMigrator } from "../../../infraproviders/migrators/transaction.discounts.migrator";
...
describe("TransactionDiscountsMigrator", () => {
  ...
  let transactionDiscountMigrator: TransactionDiscountsMigrator;
  ...
  beforeEach(async () => {
    ...
    const app: TestingModule = await Test.createTestingModule({
      ...
      providers: [DBProvider, TransactionDiscountsMigrator],
    }).compile();

    transactionDiscountMigrator = app.get<TransactionDiscountsMigrator>(TransactionDiscountsMigrator);
  ...
  describe("migrate", () => {
    it("should not do anything if there is no document", async () => {
      await transactionDiscountMigrator.migrate();
