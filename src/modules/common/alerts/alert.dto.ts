...
export enum AlertKey {
  ...
  PAYROLL_EXPIRED = "PAYROLL_EXPIRED",
  UNEXPECTED_TRANSFER_CHECK = "UNEXPECTED_TRANSFER_CHECK",
  CIRCLE_BALANCE_UPDATE_FAILED = "CIRCLE_BALANCE_UPDATE_FAILED",
  POSSIBLE_DATA_CORRUPTION = "POSSIBLE_DATA_CORRUPTION",
}
