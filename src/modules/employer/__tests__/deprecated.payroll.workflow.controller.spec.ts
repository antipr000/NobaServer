...
describe("EmployerWorkflowControllerTests", () => {
  ...
  let payrollWorkflowController: DeprecatedPayrollWorkflowController;
  ...
  beforeEach(async () => {
    ...
    payrollWorkflowController = app.get<DeprecatedPayrollWorkflowController>(DeprecatedPayrollWorkflowController);
  });
