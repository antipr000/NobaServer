...
export class ConsumerRepoMapper {
  ...
  toUpdateConsumerInput(consumerUpdateProps: Partial<ConsumerProps>): Prisma.ConsumerUpdateInput {
    return {
      ...
      ...(consumerUpdateProps.isDisabled !== undefined && { isDisabled: consumerUpdateProps.isDisabled }),
      ...(consumerUpdateProps.isLocked !== undefined && { isLocked: consumerUpdateProps.isLocked }),
