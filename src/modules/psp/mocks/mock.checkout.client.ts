...
export function getMockCheckoutClientWithDefaults(): CheckoutClient {
  ...
  when(checkoutClient.makeCardPayment(anyNumber(), anyString(), anyString(), anyString(), anyString())).thenReject(
    new Error("Method not implemented!"),
  );
  when(checkoutClient.makeACHPayment(anyNumber(), anyString(), anyString(), anyString(), anyString())).thenReject(
    new Error("Method not implemented!"),
  );
