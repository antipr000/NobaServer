    ...
    case NotificationEventType.SEND_DEPOSIT_COMPLETED_EVENT:
      data = {
        ...
        params: {
          ...
          processingFees: LocaleUtils.localizeAmount(0.1, "en-us"),
          nobaFees: LocaleUtils.localizeAmount(0.1, "en-us"),
          debitAmount: LocaleUtils.localizeAmount(5000, "en-us"),
          debitAmountNumber: 5000,
          creditAmount: LocaleUtils.localizeAmount(1, "en-us"),
          creditAmountNumber: 1,
          debitCurrency: "COP",
          creditCurrency: "USD",
          totalFees: LocaleUtils.localizeAmount(0.2, "en-us"),
          totalFeesNumber: 0.2,
          exchangeRate: LocaleUtils.localizeAmount(0.0025, "en-us", false),
        },
    ...
    case NotificationEventType.SEND_CREDIT_ADJUSTMENT_COMPLETED_EVENT:
      return {
        ...
        params: {
          transactionRef: "transaction-123",
          createdTimestamp: "2020-01-01T00:00:00.000Z",
          debitAmount: LocaleUtils.localizeAmount(1, "en-us"),
          debitAmountNumber: 1,
          creditAmount: LocaleUtils.localizeAmount(1, "en-us"),
          creditAmountNumber: 1,
          debitCurrency: "COP",
          creditCurrency: "USD",
          exchangeRate: LocaleUtils.localizeAmount(1, "en-us"),
          processingFees: LocaleUtils.localizeAmount(0, "en-us"),
