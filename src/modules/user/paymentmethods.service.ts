...
import { convertCheckoutPaymentMethodToPaymentMethodDTO, convertStripePaymentMethodToPaymentMethodDTO } from "./mappers/PaymentMethodMappers";
...
import { IUserRepo } from "./repos/UserRepo";
  ...
  export class CheckoutPaymentMethodsService {
    ...
    async getPaymentMethods(userID: string): Promise<PaymentMethodDTO[]> { 
        ...
        return  (checkoutPaymentMethods??[]).map(checkoutPaymentMethod =>  convertCheckoutPaymentMethodToPaymentMethodDTO(checkoutPaymentMethod));
    }
