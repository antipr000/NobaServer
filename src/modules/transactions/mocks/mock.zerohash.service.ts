...
export function getMockZerohashServiceWithDefaults(): ZeroHashService {
  ...
  when(mockZerohashService.makeRequest(anything(), anything(), anything())).thenReject(new Error("Method not implemented"));
  when(mockZerohashService.requestQuote(anyString(), anyString(), anything(), anything())).thenReject(new Error("Method not implemented"));
