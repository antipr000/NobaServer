...
import { TransactionLimitBuyOnly, DailyLimitBuyOnly, WeeklyLimitBuyOnly, MonthlyLimitBuyOnly, LifetimeLimitBuyOnly } from "./domain/Limits";
...
export class LimitsService {
    ...
    async canMakeTransaction(user: UserProps, transactionAmount: number): Promise<TransactionAllowedStatus> {
        ...
        if(transactionAmount > limits.transactionLimit)
            return TransactionAllowedStatus.TRANSACTION_LIMIT_REACHED;
