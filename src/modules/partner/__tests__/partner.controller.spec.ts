...
describe('PartnerController', () => {
    ...
    describe('partner service tests', () => {
        ...
        it('should get data of requesting partner admin', async () => {
            ...
            const basicAccessResult = await partnerController
                .getPartnerAdmin(
                    partnerId,
                    partnerAdminBasicAccessId,
                    {
                        user: basicAccessAdmin
                    }
                );
            const intermediateAccessResult = await partnerController
                .getPartnerAdmin(
                    partnerId,
        ...
        it('should get data of any admin with all access', async () => {
            ...
            const result = await partnerController.getPartnerAdmin(
                partnerId,
        ...
        it('should update partner details when requesting admin has all access', async () => {
            ...
            const result = await partnerController.updateTakeRate(partner.props._id, {
