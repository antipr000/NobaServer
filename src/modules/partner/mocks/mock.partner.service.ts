...
export const getmockPartnerServiceWithDefaults = () => {
  ...
  when(mockPartnerService.createPartner(anyString()))
    .thenReject(new Error("Not implemented!"));
  when(mockPartnerService.getPartner(anyString()))
    .thenReject(new Error("Not implemented!"));
  when(mockPartnerService.updatePartner(anyString(), anything()))
    .thenReject(new Error("Not implemented!"));
  when(mockPartnerService.updateTakeRate(anyString(), anyNumber()))
    .thenReject(new Error("Not implemented!"));
