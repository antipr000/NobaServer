...
when(mockedPartnerService.getPartner(mockPartner._id)).thenReturn(
  new Promise((resolve, _) => {
    resolve(partner);
  }),
);

when(mockedPartnerService.updateTakeRate(mockPartner._id, updateTakeRate)).thenReturn(
  new Promise((resolve, _) => {
    resolve(
