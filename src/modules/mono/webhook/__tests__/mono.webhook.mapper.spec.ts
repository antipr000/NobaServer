...
describe("MonoWebhookMapperTest", () => {
  ...
  describe("convertCollectionLinkCredited ()", () => {
    ...
    it("should throw InternalServiceErrorException if the signature is not valid (timestamp is different)", () => {
      ...
      expect(() =>
        monoWebhookMappers.convertCollectionLinkCredited(
    ...
    it("should throw InternalServiceErrorException if the signature is not valid (rawBody is different)", () => {
      ...
      expect(() =>
        monoWebhookMappers.convertCollectionLinkCredited(anotherWebhookEvent, webhookResponseValidSignature),
      ).toThrowError(InternalServiceErrorException);
    });
    ...
    it("should throw InternalServiceErrorException if the state is not 'account_credited'", () => {
      ...
      expect(() =>
        monoWebhookMappers.convertCollectionLinkCredited(webhookEvent, webhookResponseSignature),
      ).toThrowError(InternalServiceErrorException);
      expect(() =>
        monoWebhookMappers.convertCollectionLinkCredited(webhookEvent, webhookResponseSignature),
  ...
  describe("convertBankTransferApproved ()", () => {
    ...
    it("should throw InternalServiceErrorException if the signature is not valid (timestamp is different)", () => {
      ...
      try {
        monoWebhookMappers.convertBankTransferApproved(
          bankTransferApprovedWebhookEvent,
          webhookResponseInvalidSignature,
        );
    ...
    it("should throw InternalServiceErrorException if the signature is not valid (rawBody is different)", () => {
      ...
      try {
        monoWebhookMappers.convertBankTransferApproved(anotherWebhookEvent, webhookResponseValidSignature);
        expect(true).toBe(false);
      } catch (e) {
        expect(e).toBeInstanceOf(InternalServiceErrorException);
        expect(e.message).toContain("Invalid Mono signature");
    ...
    it("should throw InternalServiceErrorException if the type is not 'bank_transfer_approved'", () => {
      ...
      try {
        monoWebhookMappers.convertBankTransferApproved(webhookEvent, webhookResponseSignature);
        expect(true).toBe(false);
      } catch (e) {
        expect(e).toBeInstanceOf(InternalServiceErrorException);
  ...
  describe("convertBankTransferRejected ()", () => {
    ...
    it("should throw InternalServiceErrorException if the signature is not valid (timestamp is different)", () => {
      ...
      try {
        monoWebhookMappers.convertBankTransferRejected(
          bankTransferRejectedWebhookEvent,
          webhookResponseInvalidSignature,
        );
        expect(true).toBe(false);
    ...
    it("should throw InternalServiceErrorException if the signature is not valid (rawBody is different)", () => {
      ...
      try {
        monoWebhookMappers.convertBankTransferRejected(anotherWebhookEvent, webhookResponseValidSignature);
        expect(true).toBe(false);
      } catch (e) {
        expect(e).toBeInstanceOf(InternalServiceErrorException);
        expect(e.message).toContain("Invalid Mono signature");
    ...
    it("should throw InternalServiceErrorException if the type is not 'bank_transfer_rejected'", () => {
      ...
      try {
        monoWebhookMappers.convertBankTransferRejected(webhookEvent, webhookResponseSignature);
        expect(true).toBe(false);
      } catch (e) {
        expect(e).toBeInstanceOf(InternalServiceErrorException);
  ...
  describe("convertAccountCredited ()", () => {
    ...
    describe("Invalid Signature scenarios", () => {
      it("should throw InternalServiceErrorException if the signature is not valid (timestamp is different)", () => {
        ...
        try {
          monoWebhookMappers.convertAccountCredited(accountCreditedEvent, webhookResponseInvalidSignature);
          expect(true).toBe(false);
        } catch (e) {
          expect(e).toBeInstanceOf(InternalServiceErrorException);
          expect(e.message).toContain("Invalid Mono signature");
      ...
      it("should throw InternalServiceErrorException if the signature is not valid (rawBody is different)", () => {
        ...
        try {
          monoWebhookMappers.convertAccountCredited(anotherWebhookEvent, webhookResponseValidSignature);
          expect(true).toBe(false);
        } catch (e) {
          expect(e).toBeInstanceOf(InternalServiceErrorException);
          expect(e.message).toContain("Invalid Mono signature");
    ...
    describe("Invalid event scenarios", () => {
      describe("account", () => {
        ...
        it.each(requiredFields)("should throw error if '%s' is not set", field => {
          ...
          try {
            monoWebhookMappers.convertAccountCredited(localAccountCreditedEvent, signature);
            expect(true).toBe(false);
          } catch (e) {
            expect(e).toBeInstanceOf(InternalServiceErrorException);
    ...
    it("should map all the fields correctly", () => {
      const response = monoWebhookMappers.convertAccountCredited(accountCreditedEvent, webhookResponseValidSignature);
