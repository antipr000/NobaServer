...
export function getMockMonoServiceWithDefaults(): MonoService {
  ...
  when(mockMonoService.getSupportedBanks()).thenReject(new Error("Method not implemented"));
  when(mockMonoService.checkMonoHealth()).thenReject(new Error("Method not implemented"));
